function out = bilinear_resize_RGB(img, p, q)
    ...
    r_bilinear_r = bilinear_resize(r, p, q);
    v_bilinear_r = bilinear_resize(v, p, q);
    a_bilinear_r = bilinear_resize(a, p, q);
    
    % TODO: formeaza imaginea finala cu cele 3 canale de culori
    % Hint: functia cat
    out = cat(3, r_bilinear_r, v_bilinear_r, a_bilinear_r);
endfunction